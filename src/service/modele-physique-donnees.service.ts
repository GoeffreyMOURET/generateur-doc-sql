...
import InfoTable, { InfoColonne, UniqueContrainte } from "../modele/info-table.interface";
         ...
         const doc = new Document({
            sections: [{
                children: infoTables.flatMap((it) => [
                    DocxUtils.construireTitre2(`Detail de la table ${it.code}`),
    ...
    private construireTableauContraintesUnicite(infoTable: InfoTable): [Paragraph, Table,] | undefined {
        ...
        return [
            ...
            [
                ...
                { intitule: 'Colonnes concernées', contenu: (uc: UniqueContrainte) => uc.code.join(', '), },
            ],
            infoTable.uniques,
        )]
    }
